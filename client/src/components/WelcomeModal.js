      ...
      >
        ...
        >
          <div className="flex justify-between items-center p-6 border-b border-gray-200">
            <h2 className="text-2xl font-bold">Welcome to Infinite GeoWordle! 🌍</h2>
            <button onClick={onClose} className="p-1 hover:bg-gray-200 rounded-full transition-colors">
              <X size={24} />
            </button>
          </div>
          <div className="p-6 space-y-4">
            <p>Welcome to Infinite GeoWordle, where you can play endlessly! 🗺️</p>
            <div className="space-y-2">
              <p>🏙️ Guess geographical locations in 6 tries or less, as many times as you want!</p>
              ...
              <p>🔄 After each game, a new location is automatically generated</p>
            ...
            <p>Good luck and have fun exploring the world endlessly! 🌎</p>
          </div>
        </motion.div>
      </motion.div>
    </AnimatePresence>
